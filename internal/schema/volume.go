...
var VolumeSchema = &schema.BodySchema{
	Attributes: map[string]*schema.AttributeSchema{
		...
		"access_mode": {
			Description: lang.Markdown("Defines whether a volume should be available concurrently. The `access_mode` and `attachment_mode` together must exactly match one of the volume's `capability` blocks.\n\nFor CSI volumes the `access_mode` is required. Can be one of the following:\n\n- [`\"single-node-reader-only\"`](/nomad/docs/job-specification/volume#single-node-reader-only)\n- [`\"single-node-writer\"`](/nomad/docs/job-specification/volume#single-node-writer)\n- [`\"multi-node-reader-only\"`](/nomad/docs/job-specification/volume#multi-node-reader-only)\n- [`\"multi-node-single-writer\"`](/nomad/docs/job-specification/volume#multi-node-single-writer)\n- [`\"multi-node-multi-writer\"`](/nomad/docs/job-specification/volume#multi-node-multi-writer)\n\nMost CSI plugins support only single-node modes. Consult the documentation of the storage provider and CSI plugin.\n    \nFor dynamic host volumes the `access_mode` is optional. Can be one of the following:\n\n- [`\"single-node-writer\"`](/nomad/docs/job-specification/volume#single-node-writer-1)\n- [`\"single-node-reader-only\"`](/nomad/docs/job-specification/volume#single-node-reader-only-1)\n- [`\"single-node-single-writer\"`](/nomad/docs/job-specification/volume#single-node-single-writer)\n- [`\"single-node-multi-writer\"`](/nomad/docs/job-specification/volume#single-node-multi-writer)\n\nDefaults to `single-node-writer` unless `read_only = true`, in which case it defaults to `single-node-reader-only`."),
			DefaultValue: &schema.DefaultValue{
				Value: cty.StringVal(""),
			},
		},
		...
		"mount_options": {
			Description: lang.Markdown("Options for mounting CSI volumes that have the `file-system` [attachment mode](/nomad/commands/volume/register#attachment_mode). These options override the `mount_options` field from [volume registration](/nomad/commands/volume/register#mount_options). Consult the documentation for your storage provider and CSI plugin as to whether these options are required or necessary."),
			DefaultValue: &schema.DefaultValue{
