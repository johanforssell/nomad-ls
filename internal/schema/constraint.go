...
var ConstraintSchema = &schema.BodySchema{
	Attributes: map[string]*schema.AttributeSchema{
		"attribute": {
			Description: lang.Markdown("Specifies the name or reference of the attribute to examine for the constraint. This can be any of the [Nomad interpolated values](/nomad/docs/reference/runtime-variable-interpolation#interpreted_node_vars)."),
